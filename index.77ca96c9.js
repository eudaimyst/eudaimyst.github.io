...
for(var i = 0; i < 8; i++){
    ...
    div.addEventListener("click", function() {
        ...
        } else console.log(slotBuildings[slotNumber] + " clicked, setting filter");
        redrawDeckContent(0);
    });
...
for(var i = 0; i < unitList.length; i++){
    for (var [key, value] of Object.entries(unitList[i]))if (key == "health" || key == "damage" || key == "damagea" || key == "speed" || key == "range" || key == "dpsg" || key == "dpsa") {
...
function drawAllBarCharts() {
    ...
    for (var [key, value] of Object.entries(sortedUnitData))//console.log(key);
    drawBarChart(key);
}
drawAllBarCharts();
var oldE = null;
...
},{"fast-sort":"dcUgN","a49a4cf24aad666e":"kJ7AW","chart.js/auto":"d8NN9","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"dcUgN":[function(require,module,exports) {
// >>> INTERFACES <<<
// >>> HELPERS <<<
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["eaXE1","264pe"], "264pe", "parcelRequire716c")
